...
| Session | Badge | Adaptation needed |
| :-- | :-- | :-- |
| [Writer](writer.md) | Writer Activity Badge | None |
| [Entertainer](entertainer.md) | Entertainer Activity Badge | None |
| [Media Relations & Marketing](media-relations-and-marketing.md) | Media Relations & Marketing Activity Badge | None |
| [Air Spotter](air-spotter.md) | Air Spotter Activity Badge | None (needs a pre-gathered picture pack — see the session's Materials) |
...
Drop one in wherever a term needs an extra week — they don't need to sit in any particular order relative to each other or to a term's own sessions, and none of them assume anything about which term or year they're used in.
