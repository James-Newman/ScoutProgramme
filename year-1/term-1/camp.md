...
Patrols pitch their own tents and the mess tent on arrival, applying [Tent Pitching](tent-pitching.md) and [Site Layout & Design](site-layout-design.md) for real, on ground they've chosen (or been allocated) rather than a hall floor or the meeting field. Give each patrol's cook a final 15-minute check-in on their [planned camp menu](https://www.scouts.org.uk/activities/plan-your-camp-menu/), checking allergies one last time while there's still time to adjust before the shops shut. A final kit check catches anything left behind before Saturday.

**Materials:** patrol/mess tents, camp kit, menu plans from earlier in the term.
