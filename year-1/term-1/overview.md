# Year 1, Term 1 (Autumn) — Community & Global Citizenship

Term summary: [`data/terms.yaml`](../../data/terms.yaml) (year 1, term 1) · [`docs/timeline.md`](../../docs/timeline.md)

Core goals: local community research, personal and societal beliefs and attitudes, environmental action, and connecting with the wider Scout movement.
...
All 7 World Challenge Award requirements are covered this term:

> "Choose an aspect of local community life and find out as much as you can about it." — [Community Research](community-research.md)
>
> "Take part in an activity that reflects upon and explores your own beliefs, attitudes and values (this may or may not include religious beliefs)." — [Beliefs, Attitudes & Values](beliefs-attitudes-and-values.md)
>
...
>
> "Take part in an activity that explores an international issue." — [International Issues & Connections](international-issues-and-connections.md)

Source: [Scouts World Challenge Award](https://www.scouts.org.uk/scouts/awards/world/) — check the live page before formally signing anything off, since requirement wording is occasionally updated by the Scout Association.
...
Every printable file referenced above lives in [`resources/`](../../resources/README.md). See [`resources/README.md`](../../resources/README.md) for the full index across both terms.
